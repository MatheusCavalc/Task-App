...
Route::get('/my-tasks', [AppController::class, 'myTasks'])
    ->middleware(['auth', 'verified'])
    ->name('my-tasks');

Route::get('/task/{task}/details', [AppController::class, 'detailsTask'])
    ->name('task.details')
    ->middleware(['auth', 'verified', 'admin.or.editor']);
...
Route::get('/task/{task}/admin', [AppController::class, 'adminTask'])
    ->name('task.admin')
    ->middleware(['auth', 'verified']);
Route::post('/task/new-admin', [TaskController::class, 'addAdmin'])
    ->name('add.admin')
    ->middleware(['auth', 'verified']);
