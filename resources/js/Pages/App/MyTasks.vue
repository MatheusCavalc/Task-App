    ...
    <AppLayout>
        <section class="p-4">
            ...
            <div @click="openCreateForm"
                class="mt-2 flex group gap-2 cursor-pointer p-3 border border-gray-200 hover:bg-black max-w-md rounded">
                <p>
            ...
            <div :class="editTask ? 'translate-x-0 ease-out' : 'translate-x-full ease-in'"
                ...
                <div v-if="editTask">
                    <EditTaskForm :task="taskToEdit" :categories="categories" :status="task_status"
